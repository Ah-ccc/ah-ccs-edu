...
![alt text](image.png)
这个界面是配置的基础信息界面，芯片的选择和调试器的选择和一些高级设置
...
CPU Processor：
一般是JTAG调试时候会用到，我们一般都是SWD调试，所以默认选项就行了

剩下的就是一些杂七杂八的功能，想要了解的话自己去查就行了,正常来说就是默认选项就行了 
...
![alt text](image-15.png)
    该文件就是图形化配置好之后编译后的文件，也有编译后的16进制文件或者二进制文件
